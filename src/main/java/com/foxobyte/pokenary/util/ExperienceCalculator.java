...
public class ExperienceCalculator {
    /**
     * Description <br /><br />
     * \(\Delta EXP = \frac{b \times L}{7} \times \frac{1}{s} \times e \times a \times t\) <br />
     *
    ...
    /**
     * Description <br /><br />
     * \(\Delta EXP = \left( \frac{b \times L}{5} \times a \times \frac{1}{s} \times \left( \frac{\lfloor \sqrt{2L + 10} \times \left(2L + 10\right)^2 \rfloor}{\lfloor \sqrt{L \times L_{p} + 10} \times \left(L + L_{p} + 10\right)^2 \rfloor} \right) + 1 \right) \times t \times e \times p\) <br />
     *
     * @param b             int value of the base experience of the defeated Pokémon
     * @param l             int value of the level of the defeated Pokémon
    ...
    /**
     * Description <br /><br />
     * \(\Delta EXP = \frac{b \times L}{7} \times a \times \frac{1}{s} \times t \times e \times v \times f \times p\) <br />
     *
     * @param b             int value of the base experience of the defeated Pokémon
     * @param l             int value of the level of the defeated Pokémon
     * @param s             ToDo: this
    ...
    /**
     * Description <br /><br />
     * \(\Delta EXP = \left(\frac{b \times L}{5} \times \frac{1}{s} \times \left(\frac{2L+10}{L+L_{p}+10}\right)^{2.5} + 1 \right) \times t \times e \times v \times f \times p\) <br />
     *
     * @param b             int value of the base experience of the defeated Pokémon
     * @param l             int value of the level of the defeated Pokémon
     * @param lp            int value of the level of the victorious Pokémon
