    ...
    render() {
        return(
            <div className='loading'>
                ...
                >
                    <defs/>
                    <path id="shape0" transform="translate(5, 121.319996388192)" type="arc" rx="118.2" ry="118.68" cx="118.2" cy="3.61180823296029e-06" end="3.14159268402296" d="M5.68434e-14 5.27045e-14C-1.28516e-06 42.4003 22.5288 81.5798 59.1 102.78C95.6712 123.98 140.729 123.98 177.3 102.78C213.871 81.5798 236.4 42.4003 236.4 3.61181e-06" fill="#ffffff" fillRule="evenodd" stroke="#000000" strokeWidth="9.6" strokeLinecap="square" strokeLinejoin="bevel"/>
                    <path id="shape0" transform="matrix(-1 0 0 -1 241.4 121.389597439629)" type="arc" rx="118.2" ry="118.68" cx="118.2" cy="3.61180833863273e-06" end="3.14159268402296" d="M5.68434e-14 2.63425e-16C-1.28516e-06 42.4003 22.5288 81.5798 59.1 102.78C95.6712 123.98 140.729 123.98 177.3 102.78C213.871 81.5798 236.4 42.4003 236.4 3.61181e-06" fill="#ff0000" fillRule="evenodd" stroke="#000000" strokeWidth="9.6" strokeLinecap="square" strokeLinejoin="bevel"/>
